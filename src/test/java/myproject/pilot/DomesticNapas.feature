...
Feature: Napas
  ...
  Scenario: inquire Napas by account number
    ...
    And I inquire to "249515269" with "970406" cardCode from "inquireDomesticNapasFT" api
    Then I click "Send" button
    And I verify "resultCode" "00" is displayed in response
    And I verify "resultMessage" "Success" is displayed in response
    And I verify "toAccountName" "VO MINH SON" is displayed in response
  ...
  Scenario: inquire Napas by card number
    ...
    And I click on "Try it" tab
    And I input "22f20a7ccf140a86008f120bf1fb27c8" Client Secret
    And I inquire to "9704366814567141015" with "" cardCode from "inquireDomesticNapasFT" api
    Then I click "Send" button
    And I verify "resultCode" "00" is displayed in response
    And I verify "resultMessage" "Success" is displayed in response
    And I verify "toAccountName" "VO MINH SON" is displayed in response
  ...
  Scenario: inquireNapasBank
    ...
    And I click on "Try it" tab
    And I input "22f20a7ccf140a86008f120bf1fb27c8" Client Secret
    And I inquire citad bank from "inquireNapasBank" api
    Then I click "Send" button
    And I verify "resultCode" "00" is displayed in response
    And I verify "resultMessage" "Success" is displayed in response
...
#    And I click on "Try it" tab
#    And I input "22f20a7ccf140a86008f120bf1fb27c8" Client Secret
#    And I transfer from "002704070016025" to "249515269" with "1" amount and "970406" cardCode from "createDomesticNapasFT" api
#    Then I click "Send" button
#    And I verify "resultCode" "00" is displayed in response
#    And I verify "resultMessage" "Success" is displayed in response
#    And I logout with "minhson"
...
#    And I click on "Try it" tab
#    And I input "22f20a7ccf140a86008f120bf1fb27c8" Client Secret
#    And I transfer from "002704070016025" to "9704060129837294" with "1" amount and "" cardCode from "createDomesticNapasFT" api
#    Then I click "Send" button
#    And I verify "resultCode" "00" is displayed in response
#    And I verify "resultMessage" "Success" is displayed in response
#    And I logout with "minhson"

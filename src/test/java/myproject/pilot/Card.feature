...
Feature: Card Service
  ...
  Scenario: Inquire VJA Card Information
    ...
    When I access into "CardService_Product" on portal at 1 page
    And I choose version "1.0.0"
    Then I access into "inquireVJACardInfo" api
    And I click on "Try it" tab
    And I input "deb6d926-1e27-40a1-9846-dd235e839667" into Authorization
    And I inquire VJA card information with "519470187580" card number and "0983234167" user name from "inquireVJACardInfo" api
    Then I click "Send" button
    And I verify "resultMessage" "Success" is displayed in response
    And I verify "userName" "0983234167" is displayed in response
    And I verify "fullName" "VO MINH SON" is displayed in response
  ...
  Scenario: I verify VJA Payment History is inquired successfully
    ...
    And I click on "Try it" tab
    And I input "deb6d926-1e27-40a1-9846-dd235e839667" into Authorization
    And I inquire VJA payment history with "0983234167" user name, "519470187580" card number from "inquireVJAPaymentHis" api within a month
    Then I click "Send" button
    And I verify "resultMessage" "Success" is displayed in response
#    And I verify "debitor" "519470187580" is displayed in response
...
#    And I send a request otp with "513838773150" cardNumber, "20000" amount and "0983234167" userName from "createVJAPaymentRequest" api
#    Then I click "Send" button
#    And I verify "resultMessage" "Success" is displayed in response
...
#    And I click on "Try it" tab
#    And I input "a7ef291c-f7ae-41cd-9c9a-8805ffcb48b9" into Authorization
#    Then I pay VJA ticket with the above otp, "513838773150" cardNumber, "20000" amount and "0983234167" userName from "createVJAPaymentConfirm" api
...
#    And I inquire VJA payment history with "<userName>" user name, "<cardNumber>" card number from "inquireVJAPaymentHis" api within a month
#    Then I click "Send" button
...
#    And I top up from "<fromAccount>" to "<toAccount>" with "<amount>" amount from "creditPayment" api
#    Then I click "Send" button
#    And I verify "resultMessage" "Success" is displayed in response
#    And I logout with "minhson"
#    Examples:
...
#    And I click on "Try it" tab
#    And I input "f6ac5b8aa8e6d566f7e634d0fda4a356" Client Secret
#    Then I inquire credit card list with "<cif>" clientIdentifier from "inquireListCreditCard" api
#    Then I click "Send" button
#    And I verify "resultMessage" "<msg>" is displayed in response
#    And I logout with "minhson"
#    Examples:
